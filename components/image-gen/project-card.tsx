...
import { deleteImageProject } from "@/actions/image-projects";
import {
  Card,
  CardDescription,
  CardHeader,
...
export function ImageProjectCard({ project }: ImageProjectCardProps) {
  return (
    <Card className="group relative">
      <Link
        href={`/image-generation/project/${project.id}`}
